...
namespace Chess
{
    static public class Util
    {
        ...
        {
            return ((pos - Chess.Margin.ToVector2()) / Chess.SizeOfField.ToVector2()).ToPoint() + new Point(1, 1);
        }
        ...
        {
            return (Chess.Margin + new Point((pos.X - 1) * Chess.SizeOfField.X, (pos.Y - 1) * Chess.SizeOfField.Y)).ToVector2();
        }
